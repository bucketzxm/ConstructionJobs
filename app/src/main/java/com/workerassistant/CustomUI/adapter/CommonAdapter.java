package com.workerassistant.CustomUI.adapter;
...
import com.workerassistant.CityPick.ViewHolder;
...
public abstract class CommonAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
     ...
     * 所以如果使用了 HeaderAndFooterWrapperAdapter ,建议使用 {@link #setListener(int, ViewHolder)} 这个方法，返回的位置是正确的。
     *
     * @param parent
     * @param viewHolder
     * @param viewType
