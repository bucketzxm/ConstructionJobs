package com.workerassistant.CustomUI.LFRecycleview;
...
//        lfAdapter.notifyDataSetChanged();
    ...
    private void initWithContext(Context context,AttributeSet attrs) {
        ...
        recyclerViewHeader = new LFRecyclerViewHeader(context,attrs);
        recyclerViewFooter = new LFRecyclerViewFooter(context,attrs);
